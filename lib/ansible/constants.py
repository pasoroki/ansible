...
ANSIBLE_SSH_RETRIES            = get_config(p, 'ssh_connection', 'retries', 'ANSIBLE_SSH_RETRIES', 1, integer=True)
ANSIBLE_SSH_TIMEOUT            = get_config(p, 'ssh_connection', 'exec_timeout', 'ANSIBLE_SSH_TIMEOUT',      0, integer=True)
